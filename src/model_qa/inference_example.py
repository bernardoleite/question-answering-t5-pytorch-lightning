...
CONTEXT ="""
Bernardo was the first King of Portugal and Afonso is my friend.
"""
...
def run(args):
    ...
    generated = generate(args, device, qamodel, t5_tokenizer, QUESTION, CONTEXT)
    print(generated)
...
if __name__ == '__main__':
    ...
    # Add arguments
    parser.add_argument('-cmp','--checkpoint_model_path', type=str, metavar='', default="../../checkpoints/qa_en_t5_base_512_96_32_6_seed_42/model-epoch=02-val_loss=2.31.ckpt", required=False, help='Model folder checkpoint path.')
